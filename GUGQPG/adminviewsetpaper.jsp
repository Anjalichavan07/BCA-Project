...
try
{
	rs=st.executeQuery("select a.subjectname,b.coursename,c.testdate,c.maxmarks,c.passmarks,c.testid,c.completed from tblsubjects as a inner join tbltestdates as c on a.subjectid=c.subject inner join tblcourse b on c.course=b.courseid and c.completed=1 order by c.testid desc");
	%>
	<center>
...
%>
	<tr>
		...
		<td><a href="adminviewsetpaper.jsp?viewid=<%=rs.getString("testid")%>">Pattern</a></td>
		<td><a href="adminviewquestionpaper.jsp?id=<%=rs.getString("testid")%>" target="_blank">View Paper</a></td>
		...
		while(rs.next())
		{
			...
			%>
				<tr>
					...
					<td>
						<a href="adminviewsetpaper.jsp">Ok</a>
					</td>
