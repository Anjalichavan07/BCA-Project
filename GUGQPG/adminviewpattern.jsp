	...
	if(request.getParameter("id")!=null)
	{
		...
		%>
			<script language="javascript" type="text/javascript">
				...
				location.href="adminviewpattern.jsp";
			</script>
		<%
		}
	}
...
try
{
	rs=st.executeQuery("select a.subjectname,b.coursename,c.testdate,c.maxmarks,c.passmarks,c.testid,c.completed from tblsubjects as a inner join tbltestdates as c on a.subjectid=c.subject inner join tblcourse b on c.course=b.courseid and c.completed=0 order by c.testid desc");
	%>
	<center>
...
%>
	<tr>
		...
		<td><a href="adminviewpattern.jsp?viewid=<%=rs.getString("testid")%>">Pattern</a></td>
		<td><a href="adminviewpattern.jsp?id=<%=rs.getString("testid")%>">Delete</a></td>
		...
		while(rs.next())
		{
			...
			%>
				<tr>
					...
					<td>
						<a href="adminviewpattern.jsp">Ok</a>
					</td>
					<td>
						<a href="adminautosetpaper.jsp?paperid=<%=request.getParameter("viewid")%>">Set Paper</a>
					</td>
