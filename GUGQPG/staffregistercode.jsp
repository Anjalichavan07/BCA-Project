...
<script language="javascript" type="text/javascript">
    ...
    <%
		try
		{
				...
				{
					   String sql="insert into tblstaffregister values('"+txtname+"','"+lastname+"','"+txtemailid+"','"+txtmobilenumber+"','"+txtconfirmpassword+"','"+rbdgender+"','-',"+Integer.parseInt(ddlusertype)+",0)";
				...
				<script type="text/javascript" language="javascript">
					...
					location.href="staffregister.jsp";
				</script>
				<%
				}
				else
